...
const api_url = "https://esddma.herokuapp.com/service"
...
function postData() {
	...
	data = {name: name, age: age, email: email, reqdomain: reqdomain, req: req, reqstatus: reqstatus};
...
function putData() {
	...
	data = {_id: _id, name: name, age: age, email: email, reqdomain: reqdomain, req: req, reqstatus: reqstatus};
